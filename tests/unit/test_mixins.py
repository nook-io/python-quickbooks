...
class ListMixinTest(QuickbooksUnitTestCase):
    ...
    def test_where(self, query):
        ...
        query.assert_called_once_with(
            "SELECT * FROM Department WHERE Active=True STARTPOSITION 1 MAXRESULTS 10", qb=None
        )
    ...
    def test_where_start_position_0(self, query):
        ...
        query.assert_called_once_with(
            "SELECT * FROM Department WHERE Active=True STARTPOSITION 0 MAXRESULTS 10", qb=None
        )
...
class ObjectListTest(unittest.TestCase):
    ...
    def test_object_list_mixin_with_primitives(self):
        ...
        for index in range(len(test_subclass_primitive_obj)):
    ...
    def test_object_list_mixin_with_qb_objects(self):
        ...
        for index in range(len(test_subclass_object_obj)):
...
class SendMixinTest(QuickbooksUnitTestCase):
    ...
    def test_send_with_send_to_email(self, mock_misc_op):
        ...
        mock_misc_op.assert_called_with(f"invoice/2/send?sendTo={send_to_email}", None, "application/octet-stream")
